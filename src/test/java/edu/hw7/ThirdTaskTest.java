...
import edu.hw7.task3.task35.PersonDBWithRWLock;
...
public class ThirdTaskTest {
    ...
    void test(List<Person> add, List<Person> delete, List<Person> expected) {
        testDB(new PersonDB(), add, delete, expected);
        testDB(new PersonDBWithRWLock(), add, delete, expected);
    }
